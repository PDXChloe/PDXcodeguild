...
number of elements in that list. Remember len will give you the length of a list.
...
If the user enters 'done', then calculate and display the average. The following
code demonstrates how to add an element to the end of a list.
