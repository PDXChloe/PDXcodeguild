...
Hint: you're interested in comparing the two absolute differences: abs(current_guess-target)
and abs(last_guess-target).

Version 5 (optional)

Swap the user with the computer: the user will pick a number, and the computer
will make random guesses until they get it right.'''
...
while guess_count <= 9:
    ...
    if user_guess == computer_num:
        print("Congrats, you have guessed correctly using " + str(guess_count) + " guesses.")
        break
    ...
    print("Sorry that was 10 tries. Goodbye.")