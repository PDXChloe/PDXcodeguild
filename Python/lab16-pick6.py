...
#
# A ticket contains 6 numbers, 1 to 99, and the number of matches between the ticket and the
# winning numbers determines the payoff. Calculate your net winnings (the sum of all expenses and earnings).
#
